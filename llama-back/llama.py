...
def chat(prompt, **kwargs):
    ...
    prompt_template = PromptTemplate.from_template(
        ...
        As cores a serem usadas serão {primaryColor} e {secondaryColor}
